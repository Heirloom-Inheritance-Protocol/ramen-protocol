...
export default class SemaphoreEthers {
     ...
     */
    onMemberAdded(callback: (groupId: string, identityCommitment: string, merkleTreeRoot: string, event: any) => void): void;
    /**
     ...
     */
    onMemberUpdated(callback: (groupId: string, oldIdentityCommitment: string, newIdentityCommitment: string, merkleTreeRoot: string, event: any) => void): void;
    /**
     ...
     * @param callback Receives the groupId, identityCommitment and event metadata.
     */
    onMemberRemoved(callback: (groupId: string, identityCommitment: string, merkleTreeRoot: string, event: any) => void): void;
    /**
     ...
     */
    onProofValidated(callback: (proof: {
        groupId: string;
